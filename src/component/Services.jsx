...
const services =[
    {
        icon: <FaPlane className='text -4xl text-blue-500 hover:text-green-600 transform transition duration-300 hover:scale-105'/>,
    ...
    {
        icon: <FaHotel className='text-4xl text-blue-500 hover:text-green-600 transform transition duration-300 hover:scale-105'/>,
        title: 'Hotel Booking',
    ...
    {
        icon: <FaUmbrellaBeach className='text-4xl text-blue-500 hover:text-green-600 transform transition duration-300 hover:scale-105'/>,
        title: 'Beach Tours',
    ...
    {
        icon: <FaConciergeBell className='text-4xl text-blue-500 hover:text-green-600 transform transition duration-300 hover:scale-105'/>,
  ...
  return (
    <div className='py-12 bg-gray-200'>
      <div className='container mx-auto px-4'>
        <h2 className='text-4xl md:text-6xl font-bold text-center mb-10 hover:text-green-700 transform transition duration-300 hover:scale-105'>Our Services</h2>
        <div className='grid gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4'>
            {services.map((service, index) =>(
                <div key={index} className='bg-gray-100 rounded-lg shadow-md flex flex-col p-8 items-center cursor-pointer'>
                    <div className='mb-4'>{service.icon}</div>
                   
                        <h3 className='text-xl font-bold mb-6 hover:text-green-600 transform transition duration-300 hover:scale-105'>{service.title}</h3>
                        <p className='text-gray-600 hover:text-gray-700 transform transition duration-300 hover:scale-105'>{service.description}</p>
