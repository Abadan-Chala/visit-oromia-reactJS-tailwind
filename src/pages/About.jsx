     ...
     <div className='container mx-auto px-4 py-12'>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
            ...
            <div className='flex flex-col justify-center'>
                ...
                <p className='text-gray-700 mb-10 hover:text-gray-600 transform transition duration-300 hover:scale-105'>I am Abadanaf Chala, an enthusiastic and dedicated software engineering student with a strong focus on web development. My journey in technology began with a fascination for creating interactive and user-friendly applications that enhance the online experience. Currently pursuing a degree in Software Engineering at HaramayaUniversity, I have gained a solid foundation in programming languages, software design principles,Graphics Design and modern development frameworks.</p>
