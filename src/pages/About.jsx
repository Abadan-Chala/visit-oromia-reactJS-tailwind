...
const About = () => {
  return (
    <div className='bg-gray-100'>
         <div className='relative h-screen bg-cover bg-center h-96' style={{backgroundImage : "url('/assets/programmer.jpg')"}}>
         <div className='absolute inset-0 bg-black bg-opacity-50 flex flex-col items-center justify-center'>
          <h4 className='text-4xl md:text-6xl font-bold text-white mb-4'>About Me</h4>
        </div>
       </div>
     <div className='container mx-auto px-4 py-12'>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
            ...
            <div className='flex flex-col justify-center'>
                ...
                <p className='text-gray-700 mb-4'>I am Abadanaf Chala, a passionate and dedicated software engineering student with a strong focus on web development. My journey in technology began with a fascination for creating interactive and user-friendly applications that enhance the online experience. Currently pursuing a degree in Software Engineering, I have gained a solid foundation in programming languages, software design principles, and modern development frameworks.</p>
